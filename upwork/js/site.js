...
function Connect(hostname, port, proxy, connectionType, emulation) {
    ...
    HtmlTerm.Port = port;
    HtmlTerm.ProxyHostname = (proxy ? "proxy-us-ca.ftelnet.ca" : "");
	HtmlTerm.ProxyPort = 443;
...
function InitDialingDirectory() {
    DialingDirectory.push({
        ...
        'Description': 'Abacus BBS',
        'Emulation': 'ansi-bbs',
        'Hostname': 'bbs.abon.us',
        'Notes': 'Portland, OR',
        'Port': 23,
        'Proxy': true
    });
    ...
    DialingDirectory.push({
        'ConnectionCount': 0,
        'ConnectionType': 'telnet',
        'Description': 'The Shadow Dominon',
        'Emulation': 'ansi-bbs',
        'Hostname': 'bbs.abon.us',
        'Notes': 'Portland, OR',
        'Port': 23,
        ...
        'ConnectionCount': 0,
        'ConnectionType': 'telnet',
        'Description': '1st Choice Core',
        'Emulation': 'ansi-bbs',
        'Hostname': '1stchoicecore.co.nz',
        'Notes': 'Ashburton, New Zealand',
        'Port': 23,
        'Proxy': true
    });
        ...
        'ConnectionCount': 0,
        'ConnectionType': 'telnet',
        'Description': 'The Trashcan BBS',
        'Emulation': 'ansi-bbs',
        'Hostname': 'bbs.thenet.gen.nz',
        'Notes': 'Christchurch, New Zealand',
        'Port': 2323,
        'Proxy': true
    });
